...
async function getDependencies() {
  let dependencies = '@testing-library/jest-dom @testing-library/react @testing-library/user-event react react-dom react-scripts typescript';
  let devDependencies = '@types/jest @types/node @types/react @types/react-dom';
